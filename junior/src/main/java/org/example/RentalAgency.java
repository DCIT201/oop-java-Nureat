...
public class RentalAgency {
    ...
    public void rentVehicle(String vehicleId, Customer customer, int days) {
        ...
        if (vehicle == null) {
            System.out.println("Vehicle together with ID " + vehicleId + " not found.");
            return;
        }
        ...
        System.out.println("Transaction made: " + transaction.getTransactionId());
    }
    ...
    public void returnVehicle(String transactionId) {
        ...
        if (transaction == null) {
            System.out.println("Transaction together with ID " + transactionId + " not found.");
            return;
        }
        ...
        System.out.println("Vehicle brought back for transaction: " + transactionId);
    }
